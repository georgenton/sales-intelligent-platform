...
export default function LoginPage() {
  return (
    <main className="relative grid min-h-screen overflow-hidden bg-[#071a20] lg:grid-cols-[1.15fr_0.85fr]">
      <div className="relative hidden flex-col justify-between overflow-hidden p-14 text-white lg:flex">
        ...
        <div className="relative flex items-center gap-3 text-sm font-semibold tracking-[0.16em] uppercase">
          <span className="grid size-10 place-items-center rounded-xl bg-cyan-300 text-[#08242c]">
            SI
          </span>
          Sales Intelligence
        </div>
